...
const seed: AgendamentoEntity[] = [
  {
      medico: "Dr. João Silva", paciente: "Carlos Almeida", dataHorario: "2024-10-05 09:00",
      id: 0
  },
  {
      medico: "Dra. Maria Souza", paciente: "Ana Lima", dataHorario: "2024-10-06 14:00",
      id: 0
  },
];
...
describe("AgendamentoRepository", () => {
  ...
  it("save adiciona o agendamento e persiste no arquivo", async () => {
    const novo: AgendamentoEntity = {
        medico: "Dr. João Silva", paciente: "Bruno", dataHorario: "2024-10-05 10:00",
        id: 0
    };
  ...
  it("save funciona quando o arquivo está vazio", async () => {
    ...
    const novo: AgendamentoEntity = {
        medico: "Dr. X", paciente: "Y", dataHorario: "2024-12-01 09:00",
        id: 0
    };
    await repo.save(novo);
